...
public class ComputerMapperTest {
    ...
    public void testToDTO() throws MapperException {
        ComputerBuilder cb = new Computer.ComputerBuilder(123, "PC").setDateIntroduction(LocalDateTime.of(2002, 1, 1, 0, 0));
    ...
    public void testFromDTO() throws MapperException {
        ...
        ComputerBuilderDTO cb = new ComputerDTO.ComputerBuilderDTO("123", "PC").setDateIntroduction("2002-01-01").setDateDiscontinuation("2003-01-01");
    ...
    public void testFromDTOInvalidCompany() throws MapperException {
        ComputerMapper.fromDTO(new ComputerDTO.ComputerBuilderDTO("1", "aaa").setEntreprise(new CompanyDTO("unparsable", "aaa")).build());
    }
